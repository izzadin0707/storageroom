<div id="sidebar" class="bg-white shadow z-3 sidebar-open position-relative d-flex flex-column justify-content-between" style="height: 100vh;">
    <div>
        <div class="d-flex gap-2 p-3 justify-content-between align-items-center" style="cursor: pointer;">
            <span onclick="window.location.href = '<?= base_url('/') ?>'" class="title" style="width: 0; font-size: 1.3rem; color: #676df0;"><span class="fw-semibold">Storage</span>Room</span>
    ...
    <div class="d-flex justify-content-center w-100 mt-5 mb-3" style="text-wrap: nowrap;">
